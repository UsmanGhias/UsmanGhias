...
<a href="https://usmanghias.co.uk">
  <picture>
    ...
    <img src="assets/brand/profile-banner-light.jpg" width="100%" alt="Usman Ghias, Senior Odoo ERP Architect and Full-Stack Systems Engineer. Odoo 15 to 19, Python, PostgreSQL, OWL and enterprise integrations. 91+ Odoo implementations, 185+ projects delivered, 6+ years in production.">
  </picture>
</a>
...
<p align="center">
  <b>Senior Odoo ERP Architect &amp; Full-Stack Systems Engineer</b><br>
  <sub>Founder &amp; Principal Architect at <a href="https://codcrafters.org">CODCrafters</a> · Remote worldwide · UTC+5</sub>
</p>
...
<p align="center">
  <a href="https://usmanghias.co.uk"><img src="https://img.shields.io/badge/View_Portfolio-714B67?style=for-the-badge&logo=googlechrome&logoColor=white" alt="View portfolio"></a>
  <a href="mailto:iusmanghias@gmail.com?subject=Project%20enquiry%20for%20Usman%20Ghias"><img src="https://img.shields.io/badge/Discuss_a_Project-168BD2?style=for-the-badge&logo=gmail&logoColor=white" alt="Discuss a project by email"></a>
...
<picture>
  ...
  <img src="assets/brand/proof-strip-light.svg" width="100%" alt="6+ years in production, 91+ Odoo implementations, 185+ projects delivered, 70+ clients served, clients across 25+ countries, 4 production apps">
</picture>

<sub>Totals include work delivered on and off Upwork. Client names and source code are shared only where confidentiality allows.</sub>
...
<img src="assets/brand/divider-light.svg#gh-light-mode-only" width="100%" alt="">
<img src="assets/brand/divider-dark.svg#gh-dark-mode-only" width="100%" alt="">
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <b>Problem</b> · Clinical, billing, pharmacy and lab teams working in disconnected tools.<br>
      <b>Solution</b> · 50+ custom Odoo modules: patients, appointments, lab, pharmacy, insurance, billing and management dashboards.<br>
      <b>Result</b> · 50+ workflows automated; administrative overhead down about 40%.<br>
      <sub><code>Odoo</code> <code>Python</code> <code>PostgreSQL</code> <code>OWL</code></sub><br>
      <a href="https://www.codcrafters.org/industries/healthcare">View healthcare work →</a>
    </td>
    <td width="50%" valign="top">
      <h3>Automotive Workshop ERP</h3>
      <b>Problem</b> · Job cards, parts and invoicing handled manually across the workshop floor.<br>
      <b>Solution</b> · Job cards, parts &amp; inventory, customer approvals, billing and workshop reporting in one Odoo flow.<br>
      <b>Result</b> · Invoice processing time down about 60%, with near-zero manual entry errors.<br>
      <sub><code>Odoo</code> <code>Python</code> <code>QWeb</code> <code>XML</code></sub><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <b>Problem</b> · Reservations, housekeeping, restaurant and billing run by separate departments.<br>
      <b>Solution</b> · Reservations, housekeeping, POS and consolidated guest billing on a single Odoo database.<br>
      <b>Result</b> · 7 departments unified; zero double bookings.<br>
      <sub><code>Odoo</code> <code>POS</code> <code>Python</code> <code>PostgreSQL</code></sub><br>
      <a href="https://www.codcrafters.org/industries/hotel-restaurants">View hospitality work →</a>
    </td>
    <td width="50%" valign="top">
      <h3>Automotive Parts Distribution</h3>
      <b>Problem</b> · A European distributor outgrowing its catalogue, pricing and B2B ordering setup.<br>
      <b>Solution</b> · Odoo 17/18 Enterprise rollout with 15+ custom modules: dynamic pricing, parts catalogues, B2B portal, real-time carrier APIs and EU VAT rules.<br>
      <b>Result</b> · Reworked ORM and SQL queries cut report load times by about 60%.<br>
      <sub><code>Odoo 17/18</code> <code>PostgreSQL</code> <code>OWL</code> <code>Carrier APIs</code></sub><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <b>Problem</b> · Leadership reporting lived in exported spreadsheets that were slow to refresh.<br>
      <b>Solution</b> · Native Odoo Spreadsheets for multi-dimensional financial and operational analysis, extended with custom Python and OWL data retrieval.<br>
      <b>Result</b> · Automated KPI dashboards the leadership team uses for day-to-day monitoring.<br>
      <sub><code>Odoo Spreadsheets</code> <code>Python</code> <code>OWL</code> <code>PostgreSQL</code></sub><br>
      <a href="https://usmanghias.co.uk">View on portfolio →</a>
    </td>
    <td width="50%" valign="top">
      <h3>CLIVORA</h3>
      <b>Problem</b> · Freelancers and small agencies juggle clients, projects and invoices across many tools.<br>
      <b>Solution</b> · A web and Android workspace: client CRM, projects, time tracking, budgets and branded PDF invoicing, with offline storage.<br>
      <b>Result</b> · Live on the web and Google Play (v2.10.7). Product, architecture and delivery by me.<br>
      <sub><code>Flutter</code> <code>Riverpod</code> <code>Hive + SQLite</code> <code>Next.js</code></sub><br>
...
<p>
  <picture>
    ...
    <img src="https://skillicons.dev/icons?i=python,ts,js,postgres,redis,mongodb,react,nextjs,nodejs,fastapi,flutter,dart,docker,linux,aws,nginx,githubactions,git&theme=light&perline=18" width="100%" alt="Python, TypeScript, JavaScript, PostgreSQL, Redis, MongoDB, React, Next.js, Node.js, FastAPI, Flutter, Dart, Docker, Linux, AWS, Nginx, GitHub Actions, Git">
  </picture>
</p>
...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/UsmanGhias/UsmanGhias/output/github-stats-light.svg" width="100%" alt="GitHub activity: contributions, commits, pull requests, public repositories, followers and most used languages">
</picture>
...
<sub>Both images are generated daily by a GitHub Action in this repository, not by a third-party image service.</sub>
...
<p>
  <a href="mailto:iusmanghias@gmail.com?subject=Project%20enquiry%20for%20Usman%20Ghias"><img src="https://img.shields.io/badge/Discuss_a_Project-714B67?style=for-the-badge&logo=gmail&logoColor=white" alt="Discuss a project by email"></a>
  <a href="https://usmanghias.co.uk"><img src="https://img.shields.io/badge/Portfolio-9333EA?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Portfolio"></a>
  <a href="https://www.linkedin.com/in/iusmanghias"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"></a>
  <a href="https://codcrafters.org"><img src="https://img.shields.io/badge/CODCrafters-168BD2?style=for-the-badge" alt="CODCrafters"></a>
  <a href="https://www.upwork.com/freelancers/usmanghias"><img src="https://img.shields.io/badge/Upwork-14A800?style=for-the-badge&logo=upwork&logoColor=white" alt="Upwork"></a>
  <a href="https://wa.me/923126912440"><img src="https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" alt="WhatsApp"></a>
</p>

<img src="assets/brand/divider-light.svg#gh-light-mode-only" width="100%" alt="">
<img src="assets/brand/divider-dark.svg#gh-dark-mode-only" width="100%" alt="">

<p align="center"><sub>Usman Ghias · <a href="https://usmanghias.co.uk">usmanghias.co.uk</a> · Founder of <a href="https://codcrafters.org">CODCrafters</a></sub></p>
